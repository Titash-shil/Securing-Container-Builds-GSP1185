...
```
curl -LO raw.githubusercontent.com/Titash-shil/Secure-Builds-with-Cloud-Build-GSP1184/refs/heads/main/qwiklab_explorers_gsp1184.sh

sudo chmod +x qwiklab_explorers_gsp1184.sh

./qwiklab_explorers_gsp1184.sh
```
---
